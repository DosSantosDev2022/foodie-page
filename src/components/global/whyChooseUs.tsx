 ...
 * @property {Reason[]} data.reasons - Array de motivos.
 */
    ...
    <section className="py-16 lg:py-24 overflow-x-hidden">
      <div className="container mx-auto px-4">
        <div className="flex flex-col lg:flex-row items-center gap-12 lg:gap-20">
          ...
          {/* Coluna do Conteúdo */}
          <div className="w-full lg:w-1/2 text-center lg:text-left"> {/* Alinha o texto ao centro em mobile */}
            ...
            <div className="mt-8 space-y-6">
              {data.reasons.map((reason, index) => (
                ...
                >
                  {/* Garantimos que em mobile, o texto do motivo se alinhe ao centro se não houver espaço suficiente para o ícone */}
                  <div className="flex flex-col sm:flex-row items-center sm:items-start gap-4 p-4 rounded-lg bg-background/50">
